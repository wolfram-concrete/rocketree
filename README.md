...
Tailwind CSS + TypeScript**. Die App liegt im Repo-Root (direkt von Vercel deploybar). Quelle der
Wahrheit für Inhalt & Design war der statische HTML/CSS/JS-Prototyp in
[`_design-reference/`](_design-reference/) (`Rocketree Onepager.html`, `styles.css`, `viz.js` …)
sowie dessen `README.md` (Handoff).
